...
use App\Http\Controllers\Master\GrupCoaController;
use App\Http\Controllers\Master\GrupPerusahaanController;
...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('post-login', [AuthenticationController::class, 'postLogin'])->name('auth-postLogin');
    Route::post('post-registration', [AuthenticationController::class, 'postRegistration'])->name('auth-postRegistration');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'master'], function () {
        /* Route Master Lokasi Start*/
        Route::get('lokasi', [MasterController::class, 'lokasi'])->name('master-coa');
        Route::post('lokasi/store', [CoaController::class, 'store'])->name('lokasi-store');
        Route::delete('lokasi/delete/{id}', [CoaController::class, 'destroy'])->name('lokasi-delete');
        /* Route Master Lokasi End*/

        /* Route Master COA Start*/
        Route::get('coa', [MasterController::class, 'coa'])->name('master-coa');
        Route::post('coa/store', [CoaController::class, 'store'])->name('coa-store');
        Route::delete('coa/delete/{id}', [CoaController::class, 'destroy'])->name('coa-delete');
        /* Route Master COA End*/

        /* Route Master Grup COA Start*/
        Route::get('grup/coa', [MasterController::class, 'grupcoa'])->name('master-grup-coa');
        Route::post('grup/coa/store', [GrupCoaController::class, 'store'])->name('grupcoa-store');
        Route::delete('grup/coa/delete/{id}', [GrupCoaController::class, 'destroy'])->name('grupcoa-delete');
        /* Route Master Grup COA End*/

        /* Route Menu Start*/
        Route::resource('menu', MenuController::class);
        Route::get('menu', [MenuController::class, 'index'])->name('master-menu');

        /* Route Menu End*/

        /* Route Master Grup Perusahaan Start*/
        Route::resource('grup-perusahaan', GrupPerusahaanController::class);
        Route::get('grup-perusahaan', [GrupPerusahaanController::class, 'index'])->name('master-grup-perusahaan');

        /* Route Master Grup Perusahaan End*/

        /* Route Master Perusahaan Start*/
        Route::get('perusahaan', [MasterController::class, 'perusahaan'])->name('master-perusahaan');

        /* Route Master Perusahaan End*/

        /* Route Master Lokasi Start*/
        Route::get('lokasi', [DashboardController::class, 'dashboardEcommerce'])->name('master-perusahaan');
        /* Route Master Lokasi End*/
    });
    /* Route Master */
    ...
    Route::group(['prefix' => 'settings'], function () {
        /* Route Setting web Start*/
        Route::resource('web', SettingsController::class);
        Route::get('web', [SettingsController::class, 'index'])->name('web');
        /* Route Setting web End*/

        /* Route Setting menu Start*/
        Route::post('storeMenu', [SettingsController::class, 'storeMenu'])->name('storeMenu');
        Route::delete('destroyMenu/{id}', [SettingsController::class, 'destroyMenu'])->name('destroyMenu');
        Route::get('menu', [SettingsController::class, 'menu'])->name('setting-menu');
        Route::get('menu/{id}/editMenu', [SettingsController::class, 'editMenu'])->name('editMenu');
        /* Route Setting menu End*/
    });
    /* Route Settings */

    Route::group(['prefix' => 'perusahaan'], function () {
        Route::post('/create', [App\Http\Controllers\Master\PerusahaanController::class, 'create'])->name('create');
        Route::get('/delete/{id}', [App\Http\Controllers\Master\PerusahaanController::class, 'delete'])->name('delete');
        Route::post('/update', [App\Http\Controllers\Master\PerusahaanController::class, 'update'])->name('update');
        Route::get('/edit/{id}', [App\Http\Controllers\Master\PerusahaanController::class, 'edit'])->name('edit');
    });
    /* Route Dashboards */
